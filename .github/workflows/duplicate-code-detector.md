...
- **ONLY analyze .py files** - exclude all other file types
...
- **File Type Restriction**: ONLY analyze .py files - ignore all other file types
- **Primary Focus**: All .py files changed in the current push (excluding test files and workflow files)
- **Secondary Analysis**: Check for duplication with existing .py codebase (excluding test files and workflow files)
- **Cross-Reference**: Look for patterns across .py files in the repository
