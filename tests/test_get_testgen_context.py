...
#
# import pytest
# from codeflash.context.code_context_extractor import get_testgen_context
#
#
...
#     """
#
#     output = get_testgen_context(dedent(code), {"TestClass.target_method"})
...
#     """
#
#     output = get_testgen_context(dedent(code), {"TestClass.target_method"}, remove_docstrings=True)
#     assert dedent(expected).strip() == output.strip()
#
#
...
#         get_testgen_context(dedent(code), {"Outer.Inner.target_method"})
#
#
...
#     """
#
#     output = get_testgen_context(dedent(code), {"TestClass.target1", "TestClass.target2"})
#     assert dedent(code).strip() == output.strip()
#
#
...
#     """
#
#     output = get_testgen_context(dedent(code), {"target_function"})
#     assert dedent(expected).strip() == output.strip()
#
#
...
#     """
#
#     output = get_testgen_context(dedent(code), {"PlatformClass.target_method"})
#     assert dedent(code).strip() == output.strip()
#
#
...
#     """
#
#     output = get_testgen_context(dedent(code), {"DataProcessor.target_method", "ResultHandler.target_method"})
#     assert dedent(expected).strip() == output.strip()
