...
def test_function_context_includes_type_annotation() -> None:
    ...
    assert helper_functions[0].source.full_name == "test_type_annotation_context.CustomType"
...
def test_function_context_includes_type_annotation_dataclass() -> None:
    ...
    assert helper_functions[0].source.full_name == "test_type_annotation_context.CustomDataClass"
    assert helper_functions[1].source.full_name == "test_type_annotation_context.CustomType"
...
def test_function_context_custom_datatype() -> None:
    ...
    assert len(helper_functions) == 1
    assert helper_functions[0].source.full_name == "math_utils.Matrix"
