...
def test_unit_test_discovery_pytest():
    ...
    test_config = TestConfig(
        test_root=str(project_path), project_root_path=str(project_path), test_framework="pytest"
    )
...
def test_unit_test_discovery_unittest():
    ...
    test_config = TestConfig(
        test_root=str(project_path), project_root_path=str(project_path), test_framework="unittest"
    )
