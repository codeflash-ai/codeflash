...
def test_humanize_runtime():
    ...
    assert humanize_runtime(1000) == "1.0 microsecond"
    assert humanize_runtime(1000000) == "1.0 millisecond"
    assert humanize_runtime(1000000000) == "1.0 second"
    assert humanize_runtime(60000000000) == "1.0 minute"
    assert humanize_runtime(3600000000000) == "1.0 hour"
    ...
    assert humanize_runtime(123456) == "123.0 microseconds"
    assert humanize_runtime(1234567) == "1.23 millisecond"
    assert humanize_runtime(12345678) == "12.3 milliseconds"
    assert humanize_runtime(123456789) == "123.0 milliseconds"
