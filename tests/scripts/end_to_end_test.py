...
def main():
    ...
    assert (
        15000000 > improvement_pct > 30000
    ), f"Performance improvement percentage was {improvement_pct}, which was not in the range of 30,000% to 15,000,000%"
    assert (
        15000000 > improvement_x > 30000
    ), f"Performance improvement rate was {improvement_x}x, which was not in the range of 30,000x to 15,000,000"
