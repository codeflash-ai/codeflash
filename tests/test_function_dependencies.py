...
def test_simple_dependencies() -> None:
    ...
    assert helper_functions[0].source.definition.full_name == "test_function_dependencies.calculate_something"
...
def test_simple_dependencies_ann() -> None:
    ...
    assert len(helper_functions) == 2
    assert helper_functions[0].source.definition.full_name == "test_function_dependencies.MyData"
    assert (
        helper_functions[1].source.definition.full_name
...
def test_class_method_dependencies() -> None:
    ...
    assert (
        code_context.helper_functions[0].source.definition.full_name
