...
class TestUnoptimizedNeuralNet:
    ...
    def test_output_shape(self, device):
        ...
        codeflash_con = sqlite3.connect(f'/tmp/codeflash_eoe15j0k/test_return_values_{codeflash_iteration}.sqlite')
        ...
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_output_shape', 'UnoptimizedNeuralNet.forward', '5', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
    ...
    def test_softmax_normalization(self, device):
        ...
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_softmax_normalization', 'UnoptimizedNeuralNet.forward', '5', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
    ...
    def test_output_range(self, device):
        ...
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_output_range', 'UnoptimizedNeuralNet.forward', '5', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
    ...
    def test_zeros_input(self, device):
        ...
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_zeros_input', 'UnoptimizedNeuralNet.forward', '4', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
        assert output.shape == (FIXED_BATCH_SIZE, FIXED_NUM_CLASSES)
    ...
    def test_deterministic_output(self, device):
        ...
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output1 = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_deterministic_output', 'UnoptimizedNeuralNet.forward', '7', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output2 = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_deterministic_output', 'UnoptimizedNeuralNet.forward', '8', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
    ...
    def test_output_requires_grad_false(self, device):
        ...
        _call__bound__arguments = inspect.signature(model.forward).bind(x)
        _call__bound__arguments.apply_defaults()
        output = codeflash_wrap(model.forward, 'code_to_optimize.tests.pytest.test_unoptimized_neural_net', 'TestUnoptimizedNeuralNet', 'test_output_requires_grad_false', 'UnoptimizedNeuralNet.forward', '5', codeflash_loop_index, codeflash_cur, codeflash_con, *_call__bound__arguments.args, **_call__bound__arguments.kwargs)
