...
from codeflash.plugin_helpers import format_speedup_pct, map_candidate_source
...
class PluginAiOpsMixin(_Base):  # type: ignore[misc]
    ...
    def repair_candidate(
        ...
        assert trace_id, "trace_id must be provided"
        from codeflash.models.models import AIServiceCodeRepairRequest, TestDiffScope
    ...
    def adaptive_optimize(
        ...
        assert trace_id, "trace_id must be provided"
        from codeflash.models.models import AdaptiveOptimizedCandidate, AIServiceAdaptiveOptimizeRequest
