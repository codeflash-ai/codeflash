...
def init_sentry(enabled: bool = False, exclude_errors: bool = False) -> None:  # noqa: FBT001, FBT002
    if enabled:
        from codeflash.code_utils.compat import is_compiled_or_bundled_binary
        ...
        # Disable profiling in compiled mode to avoid potential compatibility issues
        profiles_sample_rate = 0.0 if is_compiled_or_bundled_binary() else 1.0
