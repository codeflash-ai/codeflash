...
class Optimizer:
    def __init__(self, args: Namespace) -> None:
        ...
        if not env_utils.ensure_codeflash_api_key():
            raise ValueError("CodeFlash API key not found or invalid")
        ...
        self.file_to_funcs_to_optimize, self.num_optimizable_functions = self.discover_functions()

        self.function_benchmark_timings = {}
        self.total_benchmark_timings = {}

    def discover_functions(self) -> tuple[dict[Path, list[FunctionToOptimize]], int]:
    ...
    def run(self) -> None:
        ...
        file_to_funcs_to_optimize = self.file_to_funcs_to_optimize
        num_optimizable_functions = self.num_optimizable_functions
