...
class ClaudeCodeIntegration:
    ...
    def _get_claude_paths(self) -> Dict[str, List[Path]]:
        ...
        if self.system == "darwin":  # macOS
            ...
            agents_paths.extend([
                self.home / ".claude" / "agents",
                self.home / ".config" / "claude" / "agents",
            ])
            ...
            agents_paths.extend([
                Path(appdata) / "Claude Code" / "agents",
                self.home / ".claude" / "agents",
            ])
        ...
        if config_path and config_path.exists():
            try:
                ...
                mcp_configured = (
                    ...
                    "codeflash" in config["mcpServers"]
                )
            except Exception:
                pass
    ...
    def setup_complete_integration(self, include_project: bool = False, project_path: Optional[Path] = None) -> Tuple[bool, str]:
