...
def optimize_function(
    function_name: str, file_path: Optional[str] = None, project_path: str = ".", create_pr: bool = True
) -> OptimizationResult:
...
@mcp.tool()
def optimize_file(file_path: str, project_path: str = ".", create_pr: bool = True) -> OptimizationResult:
...
def trace_and_optimize(
    ...
    if len(cmd_parts) < 2:
        return TraceResult(success=False, message="Invalid script command. Expected format: 'python script.py [args]'")
...
def optimize_from_replay_tests(
    test_files: List[str], project_path: str = ".", create_pr: bool = True
) -> OptimizationResult:
...
def optimize_all_functions(
    start_directory: str = ".", project_path: str = ".", create_pr: bool = True
) -> OptimizationResult:
...
@mcp.tool()
def run_benchmarks(project_path: str = ".", benchmarks_root: Optional[str] = None) -> Dict[str, Any]:
