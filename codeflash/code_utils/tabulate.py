...
def _isnumber(string):
    # Fast path to check if the string is already of numeric type
    if isinstance(string, (int, float)):
        return True

    # Check for strings that are directly convertible to float
    ...
    # For cases that aren't strings, but still need conversion check
