...
from codeflash.plugin_helpers import coverage_data_to_details_dict
from codeflash.verification.test_runner import process_generated_test_strings
...
class PluginTestLifecycleMixin(_Base):  # type: ignore[cyclic-class-definition]
    def generate_tests(
        ...
        from codeflash.verification.verifier import generate_tests as _generate_tests
        ...
        try:
            from codeflash.languages.python.static_analysis.code_extractor import (
                is_numerical_code as _is_numerical_code,
            )
    ...
    def repair_generated_tests(
        ...
        from codeflash.code_utils.code_utils import module_name_from_file_path
        from codeflash.models.models import FunctionRepairInfo
