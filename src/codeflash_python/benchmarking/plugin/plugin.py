...
class CodeFlashBenchmarkPlugin:
    ...
    def setup(self, trace_path: str | Path, project_root: str | Path) -> None:
        try:
            # Open connection
    ...
    @pytest.fixture
    def benchmark(self, request: pytest.FixtureRequest) -> CodeFlashBenchmarkPlugin.Benchmark:
    ...
    class Benchmark:  # noqa: D106
        ...
        def run_benchmark(self, func, *args, **kwargs) -> Any:  # noqa: ANN002, ANN003
            ...
            benchmark_module_path = module_name_from_file_path(
                Path(str(node_path)), Path(str(codeflash_benchmark_plugin.project_root)), traverse_up=True
            )
