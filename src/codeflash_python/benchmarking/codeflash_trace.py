...
class CodeflashTrace:
    ...
    def setup(self, trace_path: str) -> None:
        ...
        try:
            ...
            logger.warning("Database setup error: %s", e)
            if self._connection:
    ...
    def write_function_timings(self) -> None:
        ...
        try:
            ...
            logger.warning("Error writing to function timings database: %s", e)
            if self._connection:
    ...
    def __call__(self, func: F) -> F:
        ...
        def wrapper(*args, **kwargs) -> Any:  # noqa: ANN002, ANN003
            ...
            if self.function_call_count > self.pickle_count_limit:
                logger.warning("Pickle limit reached")
                self._thread_local.active_functions.remove(func_id)
            ...
            try:
                ...
                logger.warning("Error pickling arguments for function %s: %s", func.__name__, e)
