...
PYTHON_DEFAULT_FILE_EXTENSION = ".py"
PYTHON_DIR_EXCLUDES = frozenset(
    {
        "__pycache__",
        ".venv",
        "venv",
...
PYTHON_VALID_TEST_FRAMEWORKS = ("pytest", "unittest")
PYTHON_LANGUAGE_VERSION = platform.python_version()
