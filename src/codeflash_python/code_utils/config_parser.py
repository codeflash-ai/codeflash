...
def find_pyproject_toml(config_file: Path | None = None) -> Path:
    ...
    while dir_path != dir_path.parent:
        ...
        if config_file.exists():
            ...
            return config_file
        # Then check codeflash.toml (alternative config format)
...
def parse_config_file(
    ...
    except tomlkit.exceptions.ParseError as e:  # type: ignore[attr-defined]
    ...
    except tomlkit.exceptions.NonExistentKey as e:  # type: ignore[attr-defined]
    ...
    # Note: formatter-cmds defaults to empty list. Black is typically detected by the project detector.
