...
from codeflash_python.code_utils.compat import codeflash_temp_dir
...
class CodeflashRunCheckpoint:
    ...
    def initialize_checkpoint_file(self) -> None:
    ...
    def add_function_to_checkpoint(
        ...
        self.update_metadata_timestamp()
...
def ask_should_use_checkpoint_get_functions(args: argparse.Namespace) -> dict[str, dict[str, str]] | None:
